...
ActiveRecord::Schema.define(version: 20130830185456423) do
  ...
  add_index "document_documents", ["slug"], name: "index_document_documents_on_slug", unique: true, using: :btree
  ...
  add_index "document_types", ["slug"], name: "index_document_types_on_slug", unique: true, using: :btree
  ...
  add_index "messages", ["conversation_id"], name: "index_notifications_on_conversation_id", using: :btree
  ...
  add_index "user_contacts", ["user_id"], name: "index_member_contacts_on_user_id", using: :btree
  ...
  add_index "user_parameters", ["user_id"], name: "index_member_parameters_on_user_id", using: :btree
